...
public class TeamService {
    ...
    public TeamResponse createTeam(TeamRequest teamRequest) throws OpenViduJavaClientException, OpenViduHttpException {
        ...
        return new TeamResponse(teamCode, session.getSessionId());
    }
}
